sap.ui.define([
    ...
    return Controller.extend("com.apptech.DLSL.controller.PaymentRequest.PaymentRequestInquiry", {
      ...
      LoadForApproval: function () {
        ...
        this.oModel.refresh();
        $.ajax({
          url: "https://13.215.36.201:4300/app_xsjs/ExecQuery.xsjs?dbName="+ jQuery.sap.storage.Storage.get("dataBase") +"&procName=SPAPP_CHECKAPPROVAL&VALUE1=" + this.DocNum + "&VALUE2=Payment Request",
          type: "GET",
          async: false,
