sap.ui.define([
    ...
    return Controller.extend("com.apptech.DLSL.controller.Purchasing.PurchaseRequestInquiry", {
      ...
      onInit: function () {
        ...
        Router.getRoute("PurchaseRequestInquiry").attachMatched(this._onRouterMatched,this);
      ...
      LoadForApproval: function () {
        ...
        $.ajax({
          ...
          for (var i = 0; i < results.length; i++) {
            this.oModel.getData().PurchaseRequestInquiryRecords.push({
