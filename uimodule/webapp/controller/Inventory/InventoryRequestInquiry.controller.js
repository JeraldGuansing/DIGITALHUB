sap.ui.define([
    ...
    return Controller.extend("com.apptech.DLSL.controller.Inventory.InventoryRequestInquiry", {
      ...
      LoadForApproval: function () {
        ...
        this.oModel.refresh();
        $.ajax({
          url: "http://13.229.195.111:4300/app_xsjs/ExecQuery.xsjs?dbName="+ jQuery.sap.storage.Storage.get("dataBase") +"&procName=SPAPP_CHECKAPPROVAL&VALUE1=" + this.DocNum + "&VALUE2=Inventory Request",
          type: "GET",
          async: false,
